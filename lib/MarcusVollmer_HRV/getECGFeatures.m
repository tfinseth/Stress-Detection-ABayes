...
function [avgHR,meanRR,rmssd,nn50,pNN50,sd_RR,sd_HR,pse,average_hrv,hrv]= getECGFeatures(ecg_signal,samplingrate)
...
%% Calculating Power Spectral density 
    ...
    Fs1=samplingrate; %sampling rate per second
