function [accout,nDVsout,framepred,metrics,test_col_class_conmax,test_col_con] = kernal_function_Test_Realtime(testfile,table,list,classnametestvar)
%%Kernal Distribution classification
%MULTIPLE BIOMETERIC DV - TrainTest function for Realtime
%
%Author: Tor Finseth
%Date last edited: 6/21/2019
%
%
...
%VERSION: This was created to Train & Test, and output an Accuracy and
%Confusion matrix so we can compare to Weka Train&Test ouput.
%update 5-10-19, line: 305, was incorrecly grouping the actual class values alphbetically.
%update 5-16-19, tested, Gets same results are k-fold batch code.
%update 5-19-19, added ROC curve for classes on end of code
%update 6-13-19, added parfor
%update 6-17-19, made to interface with the realtime code
%update 6-21-19, training table is a input variable - reduces loadtime for training datatset

%NOTE: Be very careful what you change. This is used by both the
%ParpoolTest_ClassifierSFS & ParpoolTest_Classifier in the old and newSFS
%ParpoolTest_MAINPROGRAM.m and AdaptiveRealtime_MAINPROGRAM.m
